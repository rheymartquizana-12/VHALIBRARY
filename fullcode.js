...
onConfirm({ fullName: upperFullName, section: upperSection, date, quantity });
};
...
quantityControlContainer: {
  ...
  alignItems: "center",
  justifyContent: "space-between",
  height: 45, // Matches the height of your other inputs (input styling says 45)
  backgroundColor: "#F9F8F3",
  borderRadius: 8, // Matches the border-radius of your other inputs
  borderWidth: 1, // Matches the border-width of your other inputs
  borderColor: "#ddd", // Matches the color of your other inputs
  paddingHorizontal: 10, // Matches the padding of your other inputs
  marginTop: 4,
},
qtyValueText: {
  fontSize: 15,
