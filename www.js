...
// ✅ FIX: Format date with +08:00 offset to preserve PHT date (Asia/Manila)
const formatDateForDB = (inputDate) => {
const [month, day, year] = inputDate.split("/");
// Use noon PHT (+08:00) so UTC storage won't roll back to the previous day
return new Date(
...
// ✅ FIX: Use Asia/Manila timezone for notification time
const time = new Date().toLocaleTimeString('en-PH', {
timeZone: 'Asia/Manila',
hour: "2-digit",
minute: "2-digit",
...
// ✅ FIX: Display date in Asia/Manila timezone
...
// ✅ FIX: Calculate due date using Asia/Manila timezone
...
onPress={() => {
// ✅ FIX: Use Asia/Manila timezone for reminder time
const time = new Date().toLocaleTimeString('en-PH', {
timeZone: 'Asia/Manila',
hour: "2-digit",
minute: "2-digit",
...
const editModalStyles = StyleSheet.create({
  ...
  container: {
    backgroundColor: '#F9F8F3', // Cream / Off-white background from image
    borderRadius: 16,
    padding: 24,
    width: '90%',
    maxWidth: 450,
  ...
  title: {
    ...
    fontWeight: '700',
    color: '#1a1a2e',
    fontFamily: 'serif', // Matching the more elegant font in image
  },
  subtitle: {
    fontSize: 14,
    color: '#777',
  ...
  inputActive: {
    borderColor: '#1a4331', // Dark green border for focus like image
    borderWidth: 2,
  },
  dateRow: {
    height: 48,
  ...
  saveBtn: {
    ...
    paddingHorizontal: 20,
    borderRadius: 10,
    backgroundColor: '#1a4331', // Dark forest green from image
  },
  saveBtnText: {
    color: '#fff',
    fontWeight: '600',
...
borrowButton: {
flex: 2,
backgroundColor: '#1a4331', // Using the dark forest green from Edit form
borderRadius: 10,
paddingVertical: 12,
justifyContent: 'center',
alignItems: 'center',
